# Generated by Django 4.2.7 on 2024-05-01 10:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('inventory', '0011_rename_item_product_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='order',
            index=models.Index(fields=['-created'], name='inventory_o_created_633bba_idx'),
        ),
    ]
